...
#define TC_OSKERNELINITIALIZE_1_EN       0
#define TC_OSKERNELGETINFO_1_EN          0
#define TC_OSKERNELGETSTATE_1_EN         0
#define TC_OSKERNELGETSTATE_2_EN         0
#define TC_OSKERNELSTART_1_EN            0
#define TC_OSKERNELLOCK_1_EN             0
#define TC_OSKERNELLOCK_2_EN             0
#define TC_OSKERNELUNLOCK_1_EN           0
#define TC_OSKERNELUNLOCK_2_EN           0
#define TC_OSKERNELRESTORELOCK_1_EN      0
#define TC_OSKERNELSUSPEND_1_EN          0
#define TC_OSKERNELRESUME_1_EN           0
#define TC_OSKERNELGETTICKCOUNT_EN       0
#define TC_OSKERNELGETTICKFREQ_EN        0
#define TC_OSKERNELGETSYSTIMERCOUNT_EN   0
#define TC_OSKERNELGETSYSTIMERFREQ_EN    0
//   </e>
...
#define TC_OSTHREAD_EN                   0
#define TC_OSTHREADNEW_1_EN              1
#define TC_OSTHREADNEW_2_EN              0
#define TC_OSTHREADNEW_3_EN              0
#define TC_OSTHREADNEW_4_EN              0
#define TC_OSTHREADNEW_5_EN              0
#define TC_OSTHREADNEW_6_EN              0
#define TC_OSTHREADNEW_7_EN              0
#define TC_OSTHREADGETNAME_1_EN          0
#define TC_OSTHREADGETID_1_EN            1
#define TC_OSTHREADGETSTATE_1_EN         1
#define TC_OSTHREADGETSTATE_2_EN         0
#define TC_OSTHREADGETSTATE_3_EN         0
#define TC_OSTHREADSETPRIORITY_1_EN      1
#define TC_OSTHREADSETPRIORITY_2_EN      0
#define TC_OSTHREADGETPRIORITY_1_EN      0
#define TC_OSTHREADYIELD_1_EN            1
#define TC_OSTHREADSUSPEND_1_EN          0
#define TC_OSTHREADRESUME_1_EN           0
...
#define TC_OSTHREADEXIT_1_EN             0
#define TC_OSTHREADTERMINATE_1_EN        1
#define TC_OSTHREADGETSTACKSIZE_1_EN     0
#define TC_OSTHREADGETSTACKSPACE_1_EN    0
#define TC_OSTHREADGETCOUNT_1_EN         1
#define TC_OSTHREADENUMERATE_1_EN        1
#define TC_THREADNEW_EN                  0
#define TC_THREADMULTIINSTANCE_EN        0
#define TC_THREADTERMINATE_EN            1
#define TC_THREADRESTART_EN              0
#define TC_THREADPRIORITYEXEC_EN         0
#define TC_THREADYIELD_EN                0
#define TC_THREADSUSPENDRESUME_EN        0
...
#define TC_THREADFLAGSMAINTHREAD_EN      0
#define TC_THREADFLAGSCHILDTHREAD_EN     0
#define TC_THREADFLAGSCHILDTOPARENT_EN   0
#define TC_THREADFLAGSCHILDTOCHILD_EN    0
#define TC_THREADFLAGSWAITTIMEOUT_EN     0
#define TC_THREADFLAGSCHECKTIMEOUT_EN    0
#define TC_THREADFLAGSPARAM_EN           0
#define TC_THREADFLAGSINTERRUPTS_EN      0
//   </e>
...
#define TC_GENWAITINTERRUPTS_EN          0
//   </e>
...
#define TC_OSTIMERNEW_1_EN               0
#define TC_OSTIMERNEW_2_EN               0
#define TC_OSTIMERNEW_3_EN               0
#define TC_OSTIMERGETNAME_1_EN           0
#define TC_OSTIMERSTART_1_EN             0
#define TC_OSTIMERSTART_2_EN             0
#define TC_OSTIMERSTOP_1_EN              0
#define TC_OSTIMERSTOP_2_EN              0
#define TC_OSTIMERISRUNNING_1_EN         0
#define TC_OSTIMERDELETE_1_EN            0
#define TC_TIMERONESHOT_EN               0
#define TC_TIMERPERIODIC_EN              0
...
#define TC_OSEVENTFLAGSNEW_2_EN          0
#define TC_OSEVENTFLAGSNEW_3_EN          0
...
#define TC_OSEVENTFLAGSDELETE_1_EN       0
#define TC_OSEVENTFLAGSGETNAME_1_EN      0
#define TC_EVENTFLAGSALLOCATION_EN       0
#define TC_EVENTFLAGSINTERTHREADS_EN     0
#define TC_EVENTFLAGSCHECKTIMEOUT_EN     0
#define TC_EVENTFLAGSWAITTIMEOUT_EN      0
...
#define TC_OSMUTEXNEW_1_EN               0
#define TC_OSMUTEXNEW_2_EN               0
#define TC_OSMUTEXNEW_3_EN               0
#define TC_OSMUTEXNEW_4_EN               0
#define TC_OSMUTEXNEW_5_EN               0
#define TC_OSMUTEXNEW_6_EN               0
#define TC_OSMUTEXGETNAME_1_EN           0
#define TC_OSMUTEXACQUIRE_1_EN           0
#define TC_OSMUTEXACQUIRE_2_EN           0
#define TC_OSMUTEXRELEASE_1_EN           0
#define TC_OSMUTEXGETOWNER_1_EN          0
#define TC_OSMUTEXDELETE_1_EN            0
#define TC_MUTEXALLOCATION_EN            0
#define TC_MUTEXCHECKTIMEOUT_EN          0
#define TC_MUTEXROBUST_EN                0
#define TC_MUTEXPRIOINHERIT_EN           0
#define TC_MUTEXNESTEDACQUIRE_EN         0
#define TC_MUTEXPRIORITYINVERSION_EN     0
...
#define TC_OSSEMAPHORENEW_1_EN           0
#define TC_OSSEMAPHORENEW_2_EN           0
#define TC_OSSEMAPHORENEW_3_EN           0
#define TC_OSSEMAPHOREGETNAME_1_EN       0
#define TC_OSSEMAPHOREACQUIRE_1_EN       0
#define TC_OSSEMAPHORERELEASE_1_EN       0
#define TC_OSSEMAPHOREGETCOUNT_1_EN      0
#define TC_OSSEMAPHOREDELETE_1_EN        0
#define TC_SEMAPHOREALLOCATION_EN        0
#define TC_SEMAPHORECREATEANDDELETE_EN   0
#define TC_SEMAPHOREOBTAINCOUNTING_EN    0
#define TC_SEMAPHOREOBTAINBINARY_EN      0
#define TC_SEMAPHOREWAITFORBINARY_EN     0
#define TC_SEMAPHOREWAITFORCOUNTING_EN   0
#define TC_SEMAPHOREZEROCOUNT_EN         0
#define TC_SEMAPHOREWAITTIMEOUT_EN       0
#define TC_SEMAPHORECHECKTIMEOUT_EN      0
//   </e>
...
#define TC_OSMEMORYPOOLNEW_1_EN          0
#define TC_OSMEMORYPOOLNEW_2_EN          0
#define TC_OSMEMORYPOOLNEW_3_EN          0
#define TC_OSMEMORYPOOLGETNAME_1_EN      0
#define TC_OSMEMORYPOOLALLOC_1_EN        0
#define TC_OSMEMORYPOOLFREE_1_EN         0
#define TC_OSMEMORYPOOLGETCAPACITY_1_EN  0
#define TC_OSMEMORYPOOLGETBLOCKSIZE_1_EN 0
#define TC_OSMEMORYPOOLGETCOUNT_1_EN     0
#define TC_OSMEMORYPOOLGETSPACE_1_EN     0
#define TC_OSMEMORYPOOLDELETE_1_EN       0
#define TC_MEMPOOLALLOCATION_EN          0
#define TC_MEMPOOLALLOCANDFREE_EN        0
#define TC_MEMPOOLALLOCANDFREECOMB_EN    0
#define TC_MEMPOOLZEROINIT_EN            0
//   </e>
...
#define TC_OSMESSAGEQUEUENEW_1_EN        0
#define TC_OSMESSAGEQUEUENEW_2_EN        0
#define TC_OSMESSAGEQUEUENEW_3_EN        0
#define TC_OSMESSAGEQUEUEGETNAME_1_EN    0
#define TC_OSMESSAGEQUEUEPUT_1_EN        0
#define TC_OSMESSAGEQUEUEPUT_2_EN        0
#define TC_OSMESSAGEQUEUEGET_1_EN        0
#define TC_OSMESSAGEQUEUEGET_2_EN        0
#define TC_OSMESSAGEQUEUEGETCAPACITY_1_EN 0
#define TC_OSMESSAGEQUEUEGETMSGSIZE_1_EN 0
#define TC_OSMESSAGEQUEUEGETCOUNT_1_EN   0
#define TC_OSMESSAGEQUEUEGETSPACE_1_EN   0
#define TC_OSMESSAGEQUEUERESET_1_EN      0
#define TC_OSMESSAGEQUEUEDELETE_1_EN     0
#define TC_MSGQALLOCATION_EN             0
#define TC_MSGQBASIC_EN                  0
#define TC_MSGQWAIT_EN                   0
#define TC_MSGQCHECKTIMEOUT_EN           0
//   </e>
// </h>
// </h>
